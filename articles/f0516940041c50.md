---
title: "【資格】文系非エンジニアがProfessional Cloud DevOps Engineer（CDE）に1週間で合格した話（受験方法、勉強方法、感想）"
emoji: "🎓"
...
Professional Cloud DevOps Engineer はGCPの上級認定資格で、Goolge Cloud をDevOps（DevelopmentとOperationを組み合わせた造語）する際に必要なことを問われる資格です。
