...
- [Google Cloud Partner Top Engineer](https://rsvp.withgoogle.com/events/google-cloud-partner-top-engineer/home)というプログラムの審査基準の1つであること
    - その後[取得しました]（https://zenn.dev/hogeticlab/articles/a2cf821a678d22）
...
Professional Data Engineer はGCPの上級認定資格です。

データ駆動型の意思決定を支援するクラウドベースのデータソリューションを設計、構築、運用する能力を認定する資格です。
...
## 公式模擬問題
公式が提供する模擬問題です。（[リンク](https://docs.google.com/forms/d/e/1FAIpQLSd4j4bcgbYenBRFIL6Kb0cvXp13qCQ-z6JzowgDxRaPITn56g/viewform?hl=ja)）
...
（[リンク](https://cloud-ace.jp/column/detail473/)）
...
私は[こちら](https://www.udemy.com/course/google-cloud-professional-data-engineer-s/?couponCode=KEEPLEARNING#reviews)の模擬問題集を利用しました。
...
- 技術的な深さ
データ処理（ETL/ELT）やストレージ設計に関する詳細な質問が多く、特に BigQuery や Pub/Sub、Dataflow の理解が重要でした。
